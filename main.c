...
//_____________________________________________________________________________________________
  ...
  //HSI selected by default (00)
	RCC->PLLCKSELR &= ~(0b1 << 9);    // PRE 32 -> 0
	RCC->PLLCKSELR |= (0b1 << 6); // PRE = 4

    RCC->PLL1DIVR &= ~(0b01111111011111111111111111111111);  // all 0 without changing res Bits 31;23
    RCC->PLL1DIVR |= ((0b111011)   | //DIVN = 60  -> 960MHz
...
void delay_2MHz(void) {          //Timer for TFT output freq
 RCC->APB1LENR |= RCC_APB1LENR_TIM3EN;
